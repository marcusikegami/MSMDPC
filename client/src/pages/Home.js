    ...
    <div className="main-wrapper">
        ...
        <main id="main">
            <div className="left-column">
                <div id="formal-bio">
                    <div className="headshot-wrapper">
                        <img id="formal-headshot" alt="Headshot of Mark Scholl, M.D." src="https://scholl-static-images.s3.us-west-2.amazonaws.com/markheadshot.jfif" />
                    <p>
            ...
            <div className='right-column'>
                <div id="informal-bio">
                        <img alt='headshot of Dr. Scholl in Running Garb' src="https://scholl-static-images.s3.us-west-2.amazonaws.com/informalheadshot.jfif" />
                        <p>
