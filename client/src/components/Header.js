        ...
        <header id='header'>
          <div id='header-wrapper'>
            ...
            <div className='logo-wrapper'>
              <img id='logo' src='https://scholl-static-images.s3.us-west-2.amazonaws.com/logo.jpg' alt='Mark D. Scholl, M.D., P.C'/>
          ...
          <div className='logo-links'>
                <a className='logo-links' rel="noreferrer" target="_blank" href='https://heidenortho.com/doctors/mark-scholl/'>
                    <img alt="Heiden Orthopedics Logo" src='https://scholl-static-images.s3.us-west-2.amazonaws.com/heidenlogo.png' />
                </a>
            </div>
        </header>
